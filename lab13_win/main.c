...
int main(void)
{
    ...
    printf("\n\nEXCERCISE 2 OUTPUT\n");
    _Bool success = replace(addresses, "Babak", "no email");
    printf("\nReplace - Test 1 Output: %s\n", success?"true":"false");
    print_dictionary(addresses);
    success = replace(addresses, "Lynn", "no email");
    printf("\n\nReplace - Test 2 Output: %s\n", success?"true":"false");
    print_dictionary(addresses);
    success = replace(addresses, "Bob", "no email");
    printf("\n\nReplace - Test 3 Output: %s\n", success?"true":"false");
    print_dictionary(addresses);
